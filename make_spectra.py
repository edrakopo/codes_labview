...
#####Notes:
#Run as: python3 filename        input_directory_for_signal input_directory_for_pedestal/gate
#e.g.:   python3 make_spectra.py data/first/allC1           data/first/allC2
...
fig.savefig('plots/' + "max_voltage_vs_time.png")
...
fig.savefig('plots/' + "signal_amplitude_spectrum.png")
...
fig.savefig('plots/' + "charge_spectrum.png")
...
#    trace.savefig('plots/' + sys.argv[1] + '_' + sys.argv[2] + '_oscilloscope_traces_single.png')
    trace.savefig('plots/' + "oscilloscope_traces_single.png")
...
trace.savefig('plots/' + "oscilloscope_traces.png")
